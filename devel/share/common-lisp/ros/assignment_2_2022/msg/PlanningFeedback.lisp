...
(cl:defmethod cl:initialize-instance :after ((m <PlanningFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment_2_2022-msg:<PlanningFeedback> is deprecated: use assignment_2_2022-msg:PlanningFeedback instead.")))

(cl:ensure-generic-function 'actual_pose-val :lambda-list '(m))
(cl:defmethod actual_pose-val ((m <PlanningFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2_2022-msg:actual_pose-val is deprecated.  Use assignment_2_2022-msg:actual_pose instead.")
  (actual_pose m))

(cl:ensure-generic-function 'stat-val :lambda-list '(m))
(cl:defmethod stat-val ((m <PlanningFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2_2022-msg:stat-val is deprecated.  Use assignment_2_2022-msg:stat instead.")
  (stat m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlanningFeedback>)))
  ...
  "assignment_2_2022/PlanningFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlanningFeedback)))
  "Returns string type for a message object of type 'PlanningFeedback"
  "assignment_2_2022/PlanningFeedback")
